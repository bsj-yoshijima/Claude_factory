...
const MACH_MIN = 2;
const MACH_ART = ['normal','arabia','diner','halloween','scifi','egypt','western','onsen','japan','pirate','steampunk','dwarf','china','sushi','haunted','tokyo'];   // スプライトを用意したテーマ(assets/mach-<theme>-s<N>.png)
