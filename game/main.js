...
const ROOM_TEX = { arabia:'room_arabia', undersea:'room_undersea', japan:'room_japan', china:'room_china',
  ...
  retrofuture:'room_retrofuture', tokyo:'room_tokyo' };
...
class Main extends Phaser.Scene {
  preload(){
    ...
    for(const n of ['haunted','pirate','circuit','dwarf','hell','steampunk','retrofuture','tokyo']) this.load.image('room_'+n, `assets/room-${n}.png`);
