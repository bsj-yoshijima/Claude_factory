...
- THE DIAMOND KEEPS ITS EXACT SIZE, SHAPE AND POSITION. It is ALREADY the right size in the
  shell; you never draw a diamond. Do not enlarge it, do not stretch it, do not redraw it
  wider, do not turn it into a square standing on its corner. Its front corner already
...
- Its CONTACT POINT is the lowest pixel OF THE OBJECT ITSELF, on the centre line. It sits at
  ${num.w0} across and ${num.gy}% down from the top of the image. NOTHING goes below that
...
- THE FOUR CORNERS OF THE IMAGE STAY MAGENTA. If you have filled them, you have drawn a
  floor of your own and the object no longer fits its tile.
...
- Exactly TWO vertical faces of any box are visible: one facing lower-left, one facing
  lower-right. Never one flat face facing the viewer.
- IF THE OBJECT IS ROUND (a pool, a basin, a well, a ring of stones), its footprint is an
  ELLIPSE INSCRIBED IN THE DIAMOND: exactly TWICE AS WIDE AS IT IS DEEP, touching the
  diamond's four corners and going no further. A circle, or an ellipse flatter than 2:1,
  means the camera has tipped towards a top view and the object will not sit on its tile.
